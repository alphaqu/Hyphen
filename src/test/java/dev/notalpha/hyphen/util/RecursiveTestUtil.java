...
import dev.notalpha.hyphen.test.poly.general.DoubleC1Pain;
...
public class RecursiveTestUtil {
	...
	DynamicNode testPolyExtractWrapped() {
		return testAll("dev.notalpha.hyphen.test.poly.extract.wrapped");
	}

	@TestFactory
	DynamicNode testPolyExtractWrappedExtends() {
		return testAll("dev.notalpha.hyphen.test.poly.extract.wrappedExtends");
	}

	@TestFactory
	DynamicNode testPolyExtractWrappedSuper() {
		return testAll("dev.notalpha.hyphen.test.poly.extract.wrappedSuper");
	}

	@TestFactory
	DynamicNode testPolyGeneral() {
		return testAll("dev.notalpha.hyphen.test.poly.general");
	}

	@TestFactory
	DynamicNode testPolyEnums() {
		return testAll("dev.notalpha.hyphen.test.poly.enums");
	}

	@TestFactory
	DynamicNode testPolyWildcards() {
		return testAll("dev.notalpha.hyphen.test.poly.wildcards");
	}

	@TestFactory
	DynamicNode testSimple() {
		return testAll("dev.notalpha.hyphen.test.simple");
	}

	@TestFactory
	DynamicNode testSimpleMap() {
		return testAll("dev.notalpha.hyphen.test.simple.map");
	}

	@TestFactory
	DynamicNode testSimpleArrays() {
		return testAll("dev.notalpha.hyphen.test.simple.arrays");
	}

	@TestFactory
	DynamicNode testSimpleBuffers() {
		return testAll("dev.notalpha.hyphen.test.simple.buffer");
	}

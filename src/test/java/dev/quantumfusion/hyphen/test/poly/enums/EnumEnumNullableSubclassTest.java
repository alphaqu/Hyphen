...
@TestThis
public class EnumEnumNullableSubclassTest {
    @DataSubclasses({EnumC.class, EnumCBoolean.class, EnumCSingleton.class})
    @DataNullable
    public CM1 data;

    public EnumEnumNullableSubclassTest(CM1 data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        EnumEnumNullableSubclassTest c0IntC1 = (EnumEnumNullableSubclassTest) o;
    ...
    public static Supplier<Stream<? extends EnumEnumNullableSubclassTest>> generateEnumEnumNullableSubclassTest() {
        return cross(nullableSubClasses(
                EnumC.generateEnumC(),
                EnumCBoolean.generateEnumCBoolean(),
                EnumCSingleton.generateEnumCSingleton()), EnumEnumNullableSubclassTest::new);
    }
}

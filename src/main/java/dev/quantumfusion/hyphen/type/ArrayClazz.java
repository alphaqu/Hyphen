...
public class ArrayClazz extends Clazz {
	...
	public static ArrayClazz createGeneric(GenericArrayType array, Clazz clz, Direction dir) {
		return new ArrayClazz(Object[].class, ScanHandler.create(array.getGenericComponentType(), clz, dir));
	}

 ...
 */
public class MethodWriter extends MethodVisitor implements AutoCloseable {
	...
	public MethodWriter(MethodVisitor methodVisitor, String self, Class<?> dataClass, Class<?> ioClass) {
